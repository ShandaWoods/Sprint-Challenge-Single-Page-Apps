...
> Answer: It's much faster and the change can be instant, as opposed to server-side routing. Client-side routing provides a better user experience due to faster page load times within the application, this is because it doesn't require a server request/response and a full page refresh each time. 
## Project Set Up
